          ...
          <div className="flex-1 min-w-0 space-y-5">
            ...
            <section className="border border-gray-100 rounded-2xl overflow-hidden">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-gray-100 border-t border-gray-100">
                ...
                <div className="px-6 py-4">
                  <p className="text-sm font-semibold text-gray-900">Monthly Fees</p>
                  <p className="text-xs text-gray-400 mt-0.5">No minimums, monthly, PCI, nor statement fees</p>
                  <p className="text-sm font-bold text-brand-600 mt-1">None</p>
                </div>
                <div className="px-6 py-4">
                  <p className="text-sm font-semibold text-gray-900">Cancellation Fee</p>
                  <p className="text-xs text-gray-400 mt-0.5">No contract nor cancellation fees</p>
                  <p className="text-sm font-bold text-brand-600 mt-1">None</p>
                </div>
              </div>
            </section>
